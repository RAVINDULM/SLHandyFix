  ...
  return (
    <div>
      <div class="container lightBg">
        <Formik
          initialValues={{ firstName: "", LastName: "", address: "", email: "", nic: "" }}
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div class="row">
                ...
                <div class="col">
                  ...
                  <input type="text" class="form-control" placeholder="National identity card number" name="nic" {...formik.getFieldProps("nic")} />
                </div>
              </div>
              <div class="row">
                <div class="col">
