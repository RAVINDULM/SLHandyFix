...
const Cus_recentJob = React.lazy(() =>
  import("./pages/customer/cusRecentlyPlacedJob")
);
...
const ComplainView = React.lazy(() =>
  import("./pages/manager/mang_form/complainview")
);

// System admin routes
const SysAdmin_Dashboard = React.lazy(() =>
  import("./pages/sysAdmin/sysDashboard")
);
const Create_Account = React.lazy(() =>
  import("./pages/sysAdmin/CreateAccount")
);
const SPList = React.lazy(() => import("./pages/sysAdmin/AdminSp"));
const customerList = React.lazy(() => import("./pages/sysAdmin/AdminCus"));

// Service provider
const ServPro_Dashboard = React.lazy(() =>
  import("./pages/serviceProvider/servPro_dashboard/servProDashboard")
);
...
const routes = [
  ...
  {
    path: "/cus_viewSPprofile",
    name: "Service Provider Details",
    element: Cus_viewSPprofile,
  },
  ...
  {
    path: "/advertisments/addAdvertisement/:id",
    name: "Accept Advertisment",
    element: AdvAdd,
  },
  {
    path: "/serviceproviders/viewserviceproviders/:id",
    name: "View Service Providers",
    element: SerView,
  },
  {
    path: "/serviceproviders/updateserviceproviders/:id",
    name: "Update Service Providers",
    element: SerUpdate,
  },
  {
    path: "/customers/viewcustomers/:id",
    name: "View Customer",
    element: CusView,
  },
  {
    path: "/complaints/viewcomplains/:id",
    name: "View Complaints",
    element: ComplainView,
  },
  ...
  // System admin paths
  {
    path: "/sysAdmin_Dashboard",
    name: "System Admin Dashboard",
    element: SysAdmin_Dashboard,
  },
